...
const SABADO: Block[] = [
  ...
  { start: '11:00', end: '12:00', kind: 'baile', title: 'Salsa y bachata · academia 1',
    detail: '1 hora de clase. ~350 kcal.' },
  { start: '12:00', end: '12:45', kind: 'comida', title: 'Comida al salir · aquí SÍ cabe lo graso', avisar: 0,
    detail: 'Este es el momento de la pizza, el shawarma o lo que se te antoje. Terminaste de bailar: la grasa ya no te estorba y el músculo pide proteína.',
    ref: { type: 'receta', slot: 'comida' } },
  { start: '12:45', end: '13:45', kind: 'ruso', title: 'Traslado de regreso · escucha en ruso',
...
const DOMINGO: Block[] = [
  ...
  { start: '12:00', end: '13:15', kind: 'comida', title: 'Comida en el camino · la que decide tu domingo',
    detail: 'Aquí SÍ cabe lo graso, ya bailaste. Pero busca proteína de verdad: pollo, pescado, huevos u otra leche proteica. Te faltan 2 h 20 min de baile y no puedes entrar en déficit ahora.',
    ref: { type: 'receta', slot: 'comida' } },
  ...
  { start: '19:00', end: '20:00', kind: 'prep', title: 'MEAL PREP de la semana', avisar: 5,
    detail: 'La hora más rentable de tu semana. Con la despensa de ahora: 500 g de pollo en dos tandas de 250 g (nunca de golpe, se cuece al vapor), 4 bolsitas de гречка y 8 huevos cocidos. Deja también la mochila del sábado hecha: leche proteica, plátanos y pan con miel.' },
