...
export const WORKOUTS: Record<string, Workout> = {
  f1a: {
    ...
    phase: 1,
    focus: 'Espalda · Bíceps · Empuje ligero',
    durationMin: 60,
    items: [
      ...
      { exerciseId: 'fondoParalelas', rx: { sets: 3, reps: '6-10', rir: 1, rest: 105, tempo: 3 },
        note: 'AÑADIDO 2026-08-21. El empuje solo se entrenaba los miércoles: una vez por semana, y si perdías ese día tu pecho no recibía nada en siete días. Aquí van 3 series de mantenimiento, sin llegar al fallo — el trabajo duro de pecho sigue siendo el miércoles.' },
  ...
  f1b: {
    ...
    items: [
      ...
      { exerciseId: 'flexionDiamante', rx: { sets: 2, reps: 'AMRAP', rir: 0, rest: 60 },
        note: 'De 3 series a 2: el empuje ahora aparece también lunes y viernes, así que esta sesión ya no tiene que cargar con todo el volumen semanal de pecho y tríceps ella sola.' },
  ...
  f1c: {
    ...
    items: [
      ...
      { exerciseId: 'remoBarraBaja', rx: { sets: 3, reps: '8-12', rir: 1, rest: 90, tempo: 2 },
        note: 'Antes era AMRAP a RIR 0. En esta sesión ya llegas al fallo en la dominada, el curl y el gemelo: cuatro ejercicios al fallo el mismo día generan más fatiga que estímulo. Aquí quédate a una repetición.' },
      ...
      { exerciseId: 'flexionInclinada', rx: { sets: 3, reps: '8-15', rir: 1, rest: 75, tempo: 2 },
        note: 'SUSTITUYE AL GEMELO (2026-08-21). Bailas 3 h 20 min de salsa cada fin de semana: tus gemelos y sóleos ya reciben más volumen del que cualquier serie de elevaciones les puede dar. Ese hueco rinde mucho más en pecho, que es de lo que menos haces y de lo que más marca la ropa.' },
    ],
  },
